      ...
      <div className="w-full max-w-md sm:p-8 space-y-8 sm:bg-white sm:rounded-lg sm:shadow-lg">
        <div className="flex items-center justify-center space-x-3">
          ...
          <div className="text-left">
            ...
            <p className="text-gray-700 text-xl font-semibold">Dashboard</p>
          </div>
        </div>
        <p className="text-xl font-semibold text-center text-gray-700">
          This page is currently under development. There are no other contents available to view for now.
        </p>
